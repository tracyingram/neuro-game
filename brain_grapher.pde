...
void setup() {
  ...
  foutput.println("Timestamp, Signal Quality, Attention, Meditation, Delta, Theta, Low Alpha, High Alpha, Low Beta, High Beta, Low Gamma, High Gamma");
}
...
void serialEvent(Serial p) {
  ...
  String serin = p.readString();
  Date d = new Date();
  foutput.print(d.getTime());
  foutput.print(", ");
  foutput.print(serin);
  foutput.flush();
  String[] incomingValues = split(serin, ',');
